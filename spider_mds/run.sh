...
es_password=
scrapyd_password=
# scrapy crawl m3u8 -s MIRAI_API_KEY=$mirai_api_key -s ES_PASSWORD=$es_password --logfile=m3u8.log
curl https://scrapyd.gwq5210.com/schedule.json -u gwq5210:$scrapyd_password \
  ...
  -d setting=PAGE_LIMIT_COUNT=-1 -d setting=FILES_STORE=/usr/share/scrapyd/m3u8